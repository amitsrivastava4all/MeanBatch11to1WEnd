...
app.directive("tcsHeadTag",function(){
	return {
		template:`<link rel="stylesheet" href="bootstrap.min.css"  crossorigin="anonymous"><script src='bootstrap.min.js'></script>`,
		restrict : 'E'
	}
})
...
app.factory("myfactory",function(){
	var object = {
		menu:[{value:"Home",url:"#/home"}, {value:"ContactUs",url:"#/contact"},{value:"AboutUs",url:"#/about"}],
		brand:"BOA"
	};
	return object;
})
